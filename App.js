...
const API_KEY = "e69c6ba7"; // Reemplaza con tu propia API key de OMDb
    ...
    <SafeAreaView style={styles.container}>
      ...
      {movieData && (
        <View style={styles.result}>
          ...
          <Text style={styles.movieDetail}>Director: {movieData.Director}</Text>
          <Text style={styles.movieDetail}>Actores: {movieData.Actors}</Text>
          <Text style={styles.movieDetail}>Género: {movieData.Genre}</Text>
